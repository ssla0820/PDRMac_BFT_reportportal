...
# For Report >>
report = MyReport("MyReport", driver=mwc, html_name="Fix Enhance_part2.html")
uuid = report.uuid
...
Ground_Truth_Folder = app.ground_truth_root + '/Fix_Enhance_part2/'
Auto_Ground_Truth_Folder = app.auto_ground_truth_root + '/Fix_Enhance_part2/'
...
class Test_Fix_Enhance_2():
    ...
    def setup_class(cls):
        ...
        if get_enable_case_execution_log():
            google_sheet_execution_log_init('Fix_Enhance_2')
    ...
    def test_1_1_1(self):
        with uuid("7e8e9b8c-5720-4ead-9e82-12b99ce10e7e") as case:
            ...
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H121_CA_Exposure(100).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H121_CA_Exposure(100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("2d17b5a3-00c7-4389-9730-65ebe4f8ebd5") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H125_CA_Exposure(up_down).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H125_CA_Exposure(up_down).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("9389ee7e-aba5-4400-89b0-a91e086ac6ac") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H122_CA_Exposure(slider80).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H122_CA_Exposure(slider80).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
            case.result = compare_result and exposure_result
        ...
        with uuid("cf6919b6-eb90-4720-86ba-2f26d9e42c18") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H123_CA_Exposure(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H123_CA_Exposure(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("7c232f60-7aa7-45d3-b46f-5c7df607b641") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H124_CA_Exposure(200).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H124_CA_Exposure(200).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
    ...
    def test_1_1_2(self):
        with uuid("5ddec5b2-603c-4d73-988f-c46d9266b587") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H126_CA_Brightness(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H126_CA_Brightness(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("d2b8be81-7255-4d10-8480-963b40b452ec") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H130_CA_Brightness(up_down).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H130_CA_Brightness(up_down).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("2d6e991b-fa3e-4c12-b7d8-7cec7de6c0e3") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H127_CA_Brightness(slider-60).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H127_CA_Brightness(slider-60).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
            case.result = compare_result and brightness_result
        ...
        with uuid("7a083fdf-3e29-427d-bddf-5a43ecfc0685") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H128_CA_Brightness(-100).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H128_CA_Brightness(-100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("9298db82-a705-421e-9150-968838a879aa") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H129_CA_Brightness(100).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H129_CA_Brightness(100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
    ...
    def test_1_1_3(self):
        with uuid("0481c7d7-3ad1-4be3-8c20-c11e1bad2fd6") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H131_CA_Contrast(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H131_CA_Contrast(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("50a1eedf-f924-4284-90cb-ae4749677b4f") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H135_CA_Contrast(up_down).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H135_CA_Contrast(up_down).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("f9246f17-6645-4897-818c-ef820fefbc18") as case:
            ...
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H132_CA_Contrast(slider90).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("c4f5a647-b9d3-41a2-8425-1c88365d0f4a") as case:
            ...
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H133_CA_Contrast(-100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
            case.result = compare_result and contrast_min_result
    ...
    def test_1_1_4(self):
        with uuid("bdb9efaa-ae78-4cd5-a489-643e86545fb5") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H136_CA_Hue(100).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H136_CA_Hue(100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("ae4d33db-8cad-4809-b481-1ba694480476") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H140_CA_Hue(up_down).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H140_CA_Hue(up_down).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("9bad7be2-268e-493a-82da-cbfb8878c628") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H138_CA_Hue(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H138_CA_Hue(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("9bf27615-7015-40d3-9255-8c5b24cf975a") as case:
            ...
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H139_CA_Hue(200).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
    ...
    def test_1_1_5(self):
        with uuid("bdd606e6-db3b-4d61-8fff-d55a8828a107") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H141_CA_Saturation(100).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H141_CA_Saturation(100).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("29196787-1a3d-4f33-8c62-e875fcfa5e26") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H145_CA_Saturation(up_down).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H145_CA_Saturation(up_down).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("84a00013-bf2a-4633-b774-2584c86c748e") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H142_CA_Saturation(slider40).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H142_CA_Saturation(slider40).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
            case.result = compare_result and saturation_up_result and saturation_down_result
        ...
        with uuid("86cbab8a-c946-4ed8-a5ff-d9c730959ee4") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H143_CA_Saturation(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H143_CA_Saturation(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("988c2e99-9a04-4846-91e8-4ba6c6f37d78") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H144_CA_Saturation(200).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H144_CA_Saturation(200).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
            case.result = compare_result and saturation_min_result
    ...
    def test_1_1_6(self):
        with uuid("cbb30b12-d778-4402-bec1-09210ddecd33") as case:
            ...
            # Check Current testing image to be Original image or NOT
            current_image = media_room_page.snapshot(locator=media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H146_CA_Vibrancy(0).png')
            # Move Current testing image into Ground_Truth folder if AT_Ground_Truth folder is empty
            original_image = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                      file_name=Ground_Truth_Folder + 'H146_CA_Vibrancy(0).png')
            # Compare result
            compare_result = media_room_page.compare(current_image, original_image)
        ...
        with uuid("7e1798e9-6718-4378-ae73-d8f6b1f3f9c5") as case:
            ...
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H147_CA_Vibrancy(slider-50).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H147_CA_Vibrancy(slider-50).png')
            case.result = media_room_page.compare(before_result, after_result)

        with uuid("07d1104a-2fa9-4a36-b46b-88bd4c3fec4e") as case:
            # Switch to Color Adjustment > Set Vibrancy = 0 by keyboard inputting
            fix_enhance_page.enhance.switch_to_color_adjustment()
            fix_enhance_page.enhance.color_adjustment.vibrancy.set_value(-100)
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H148_CA_Vibrancy(-100).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H148_CA_Vibrancy(-100).png')
            case.result = media_room_page.compare(before_result, after_result)

        with uuid("0f572a24-c3cf-40e1-a209-f70fbcfe4151") as case:
            # Switch to Color Adjustment > Set Vibrancy = 200 by keyboard inputting
            fix_enhance_page.enhance.switch_to_color_adjustment()
            fix_enhance_page.enhance.color_adjustment.vibrancy.set_value(100)
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H149_CA_Vibrancy(100).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H149_CA_Vibrancy(100).png')
            case.result = media_room_page.compare(before_result, after_result)
    ...
    def test_1_1_7(self):
        with uuid("fa5085b8-a1ec-4d12-88dd-2b7d8f123a27") as case:
            ...
            # Snapshot image of preview window after CA is ticked
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H151_CA_Highlight_Healing(0).png')
            fix_enhance_page.enhance.color_adjustment.highlight_healing.set_value(0)
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H151_CA_Highlight_Healing(0).png')
        ...
        with uuid("44de4a85-822e-4205-beaa-f5d0b505b58a") as case:
            # Switch to Color Adjustment > Adjust Highlight Healing by Up and Down arrow
            fix_enhance_page.enhance.switch_to_color_adjustment()
        ...
        with uuid("eb9e45cd-6948-472e-bbbc-e04b0f69eb62") as case:
            ...
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H152_CA_Highlight_Healing(slider75).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H152_CA_Highlight_Healing(slider75).png')
            case.result = media_room_page.compare(before_result, after_result)

        with uuid("ae628996-4132-449d-b708-2a300b70292c") as case:
            # Switch to Color Adjustment > Set Highlight Healing = 100 by keyboard inputting
            fix_enhance_page.enhance.switch_to_color_adjustment()
            fix_enhance_page.enhance.color_adjustment.highlight_healing.set_value(100)
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H153_CA_Highlight_Healing(100).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H153_CA_Highlight_Healing(100).png')
            case.result = media_room_page.compare(before_result, after_result)
    ...
    def test_1_1_8(self):
        with uuid("049a61e0-c94d-4b16-bfa5-d1faa8587d3f") as case:
            ...
            # Snapshot image of preview window after CA is ticked
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H155_CA_Shadow(0).png')
            fix_enhance_page.enhance.color_adjustment.shadow.set_value(0)
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H155_CA_Shadow(0).png')
            compare_result = media_room_page.compare(before_result, after_result)
            case.result = compare_result and shadow_result

        with uuid("d3254ce5-44fd-4388-b824-fefb02d24007") as case:
            # Switch to Color Adjustment > Adjust Shadow by Up and Down arrow
            fix_enhance_page.enhance.switch_to_color_adjustment()
            ...
            case.result = shadow_up_result and shadow_down_result
        ...
        with uuid("a4afaa0a-9d5c-4130-8377-384e0b53107e") as case:
            ...
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H156_CA_Shadow(slider30).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H156_CA_Shadow(slider30).png')
            case.result = media_room_page.compare(before_result, after_result)

        with uuid("1627437a-f61a-4484-aeca-124eabcaaf06") as case:
            # Switch to Color Adjustment > Set Shadow = 100 by keyboard inputting
            fix_enhance_page.enhance.switch_to_color_adjustment()
            fix_enhance_page.enhance.color_adjustment.shadow.set_value(100)
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H157_CA_Shadow(100).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H157_CA_Shadow(100).png')
            case.result = media_room_page.compare(before_result, after_result)
    ...
    def test_1_1_9(self):
        with uuid("76da2dab-390f-493d-9227-454df1b69172") as case:
            ...
            # Snapshot image of preview window after CA is ticked
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H159_CA_Sharpness(0).png')
            fix_enhance_page.enhance.color_adjustment.sharpness.set_value(0)
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H159_CA_Sharpness(0).png')
            compare_result = media_room_page.compare(before_result, after_result)
            case.result = compare_result and sharpness_result
        ...
        with uuid("306f9d09-9dfa-4fe2-b1a9-5efacbdfb091") as case:
            ...
            case.result = sharpness_up_result and sharpness_down_result
        ...
        with uuid("eb768121-116d-45cb-86db-d5290c8f0d9e") as case:
            ...
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H160_CA_Sharpness(slider55).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H160_CA_Sharpness(slider55).png')
            case.result = media_room_page.compare(before_result, after_result)

        with uuid("c481d00d-2794-4318-add8-7edc1cd310b2") as case:
            # Switch to Color Adjustment > Set Sharpness = 100 by keyboard inputting
            fix_enhance_page.enhance.switch_to_color_adjustment()
            fix_enhance_page.enhance.color_adjustment.sharpness.set_value(100)
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H161_CA_Sharpness(100).png')
            # Snapshot image of preview window after CA is ticked
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H161_CA_Sharpness(100).png')
            case.result = media_room_page.compare(before_result, after_result)
    ...
    def test_1_1_10(self):
        with uuid("63f3499b-3f98-40cd-9ebe-232497de42df") as case:
            ...
            # Snapshot image of Applied Status
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H120_CA_Checked.png')
            ...
            #logger(checkbox_result)

            # Snapshot image of Color Adjustment checkbox
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H120_CA_Checked.png')
            compare_result = media_room_page.compare(before_result, after_result)
            case.result = checkbox_result and compare_result
        ...
        with uuid("b791285a-63cb-4ce5-8def-9508eac81028") as case:
            # Undo * Untick Color Adjustment checkbox
            main_page.click_undo()
            time.sleep(1)

            # Snapshot image of Applied Status
            before_result = media_room_page.snapshot(locator = media_room_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'H163_CA_Reset.png')
            ...
            # Redo * Tick Color Adjustment checkbox
            ...
            after_result = media_room_page.snapshot(locator=media_room_page.area.preview.main,
                                                    file_name=Ground_Truth_Folder + 'H163_CA_Reset.png')
            compare_result = media_room_page.compare(before_result, after_result)
