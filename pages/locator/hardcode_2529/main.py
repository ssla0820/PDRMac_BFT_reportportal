...
class timeline():
    ...
    clip_name_unit = {'AXIdentifier': '_NS:66'} # hardcode_0427: IDC_VIDEOCELL_ALIAS
...
class library_preview_window():
    slider = {'AXRole': 'AXSlider', 'AXIdentifier': '_NS:12'} # hardcode_0427: IDC_SELECTSLIDER_SLIDER, from context menu of library clip > show in library preview window
...
class serious_frame_drop_decteced_dialog():
    ...
    description = [main_window, {'AXIdentifier': '_NS:34'}] # hardcode_0427: IDC_CLALERT_MESSAGE
