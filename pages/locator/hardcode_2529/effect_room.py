...
clut_effect_tag = [{'AXIdentifier': 'IDD_LIBRARY'}, {'AXIdentifier': '_NS:241'}, {'AXRole': 'AXRow', 'index': 2}, {'AXIdentifier': 'RoomTagOutlineViewTextField', 'AXRoleDescription': 'text'}]
library = {'AXIdentifier': 'IDD_LIBRARY'}
class library_menu:
...
remove_effect_setting = {'AXIdentifier': '_NS:40', 'AXRoleDescription': 'button'}
