...
# For Report >>
report = MyReport("MyReport", driver=mac, html_name="PDR216 MAC BFT Ess 20230720.html")
uuid = report.uuid
...
class Test_BFT_Essential():
    ...
    def setup_class(cls):
        ...
        if get_enable_case_execution_log():
            google_sheet_execution_log_init('Test_BFT_Essential')
    ...
    def teardown_class(cls):
        ...
        report.export()
        logger(
            f"Test_BFT_Essential result={report.get_ovinfo('pass')}, {report.fail_number=}, {report.get_ovinfo('na')}, {report.get_ovinfo('skip')}, {report.get_ovinfo('duration')}")
    ...
    # Essentail launch App
    def start_essential_app(self):
        # launch PDR
        logger('Launch PDR')
        main_page.launch_app()
        time.sleep(10)

        logger('RUN follow up')
        # Click [Launch Free Version]
        free_version_link = main_page.exist({'AXTitle': 'LAUNCH FREE VERSION', 'AXRole': 'AXLink'}, timeout=10)
        free_version_btn = main_page.exist({'AXTitle': 'Launch Free Version', 'AXRole': 'AXButton'}, timeout=10)
        ...
        # Handle seasonal dialog
        if main_page.exist(L.base.seasonal_bb_window.main):
            main_page.press_esc_key()
            logger('handle seasonal dialog')
            time.sleep(2)

    def essential_close_and_restart_app(self):
        # Relaunch PDR
        main_page.close_app()
        time.sleep(DELAY_TIME * 2)
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)

        # click [Use sample media]
        media_room_page.click_use_sample_media()
    ...
    def open_project_occurred_file_missing(self):
        # If occurred file mssing, current window can find [Browse] button and [Ignore All] button
        check_browse = main_page.is_exist(L.main.cyberlink_powerdirector_dialog.btn_browse)
        check_ignore_all = main_page.is_exist(L.main.cyberlink_powerdirector_dialog.btn_ignore_all)
        if check_browse and check_ignore_all:
            return True
        else:
            return False
    ...
    def test_1_1_1(self):
        ...
        # [L11] Launch PDR Essential build
        ...
        with uuid("89b5f8e9-dc8f-42d7-9fda-2771939dfb81") as case:
            ...
            email_string = 'sistarftcn.007@gmail.com'
            ...
            if main_page.is_exist({'AXValue': 'sistarftcn.007@gmail.com', 'AXRole': 'AXStaticText'}):
                verify_step = True
    ...
    def test_1_1_2(self):
        ...
        # [L220] 3.1 Video Intro Designer > Modify template > From Favorites
        ...
        # [L221] 3.1 Video Intro Designer > Preview template
        ...
        # [L222] 3.1 Video Intro Designer > Edit > Change template duration
        ...
        # [L228] 3.1 Video Intro Designer > Edit > Flip
        with uuid("446754c9-6571-412a-944a-250869146a1d") as case:
            ...
            current_image = intro_video_page.snapshot(locator=L.intro_video_room.intro_video_designer.preview_area,
                                                      file_name=Auto_Ground_Truth_Folder + 'I228_flip_vertically.png')
            time.sleep(DELAY_TIME)
            check_vertically = main_page.compare(Ground_Truth_Folder + 'I228_flip_vertically.png', current_image)

            # Click flip horizontally
            intro_video_page.click_flip(1)

            current_image = intro_video_page.snapshot(locator=L.intro_video_room.intro_video_designer.preview_area,
                                                      file_name=Auto_Ground_Truth_Folder + 'I228_flip_horizontally.png')
            time.sleep(DELAY_TIME)
            check_horizontally = main_page.compare(Ground_Truth_Folder + 'I228_flip_horizontally.png', current_image)

            case.result = check_vertically and check_horizontally
        ...
        # [L225] 3.1 Video Intro Designer > Edit > Replace master video correctly from Color Board
        ...
        # [L232] 3.1 Video Intro Designer > Edit > Add Color Board (Able to modify setting for color board)
        ...
        # [L223] 3.1 Video Intro Designer > Edit > Replace master video from local content
        with uuid("6e03aff5-5870-41fc-add3-a2358348a59a") as case:
            ...
            # [L227] 3.1 Video Intro Designer > Edit > Trim Video
        ...
        with uuid("f4df2783-70c0-4745-9d5c-fadc90167b44") as case:
            with uuid("8c048835-df6d-4d2a-af28-4fdba6c2a2ad") as case:
                ...
                # [L233] 3.1 Video Intro Designer > Edit > Apply LUT
        ...
        # Save Template
        intro_video_page.click_btn_save_as('test_1_1_2')
    ...
    def test_1_1_3(self):
        ...
        # Select 1st template "test_1_1_2"
        intro_video_page.select_intro_template_method_2(1)
        main_page.double_click()
        time.sleep(DELAY_TIME * 6)

        # [L229] 3.1 Video Intro Designer > Edit > Add general title
        ...
        current_image = intro_video_page.snapshot(locator=L.intro_video_room.intro_video_designer.preview_area)
        # [L224] 3.1 Video Intro Designer > Edit > Download and replace master video correctly form Stock Content
        with uuid("73912396-9399-463e-8fde-9e4e5c68b91e") as case:
            ...
            has_something_update = main_page.compare(current_image, img_updated, similarity=0.5)
            case.result = (not check_SS_result) and has_something_update

        # [L230] 3.1 Video Intro Designer > Edit > Add MGT
        with uuid("4c6d937b-e72a-4ed9-852c-2c1134cb7812") as case:
            ...
            # [L235] 3.1 Video Intro Designer > Edit > Change layer order
        ...
        # [L226] 3.1 Video Intro Designer > Edit > Crop
        ...
        # [L231] 3.1 Video Intro Designer > Edit > Add image
        with uuid("59ddae48-a065-48f3-a593-06cbf725c81f") as case:
            ...
            check_image_result = intro_video_page.image.in_animation.select_template('Fade')
            time.sleep(DELAY_TIME)
        ...
        # [L236] 3.1 Video Intro Designer > Edit > Add BGM
        # 2023/05/05 update: Skip this case << Download from Meta / Shutterstock (Music) >>

        # [L239] 3.1 Video Intro Designer > Save Template
        with uuid("3049da80-c0d6-40f7-86db-e317ef278b7b") as case:
            intro_video_page.click_btn_save_as('test_1_1_3')
        ...
        # [L238] 3.1 Video Intro Designer > Share after modify
        ...
        # [L240] 3.1 Video Intro Designer > Add to timeline
        with uuid("6ba6a1b7-3d61-43fd-97b8-17b5865d7d5a") as case:
            ...
            main_page.handle_save_file_dialog(name='test_case_1_1_3',
                                              folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

            current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_3.pds'
            logger(current_save_project_path)
        ...
        # Verify step [Produce]
        # click [Export] to enter produce page
        ...
        if current_file_extension != 'M2TS':
            logger(current_file_extension)
            raise Exception

        # Produce > H.264 > Format : 1280x720/24p
        ...
        # Produce > H.264 > Select encode type (HW)
        produce_page.local.set_fast_video_rendering_hardware_encode()
        time.sleep(DELAY_TIME)

        # Produce > H.264 > Start [Produce]
        # Start : produce
        ...
        # Back to Edit
        produce_page.click(L.produce.btn_back_to_edit_page)
        time.sleep(DELAY_TIME * 5)

        # Verify step:
        # Whether (Media Room) can find the produced clip : explore_file
        # Can find => Not thing
        # CAN NOT find => delete current saved project : current_save_project_path
        check_explore_file_correct = main_page.is_exist({"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('Test_1_1_3: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    def test_1_1_4(self):
        ...
        # If test_case_1_1_3 doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_3.pds'):
            logger('CAN NOT find test_case_1_1_3.pds')
            return
        ...
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_3.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')

        # if occurred file missing, handle it
        if main_page.is_exist(L.main.cyberlink_powerdirector_dialog.description_open_project_file_missing):
            project_new_page.open_project.file_missing.click_browse()
            time.sleep(DELAY_TIME)
            main_page.select_file(Test_Material_Folder + 'File_Missing/pdz28f15.mov')
            time.sleep(DELAY_TIME * 5)

        # [L242] 3.2 Title Designer > Open Title designer
        ...
        # if Font Face is unfold, click arrow to fold
        title_designer_page.unfold_object_font_face_tab(0)
        time.sleep(DELAY_TIME * 2)

        # [L243] 3.2 Title Designer > Modify > Input text case
        ...
        # [L247] 3.2 Title Designer > Set in [Object] > Font /Paragraph
        with uuid("7b458139-00b3-4178-a4f6-8515fc581f6a") as case:
            ...
            # [L245] 3.2 Title Designer > Switch to Advanced mode
        ...
        # [L246] 3.2 Title Designer > Set in [Object] > Character Presets
        ...
        # [L251] 3.2 Title Designer > Set in [Object] > Backdrop
        ...
        # [L244] 3.2 Title Designer > Insert new title
        ...
        # [L250] 3.2 Title Designer > Set in [Object] > Shadow
        ...
        # Save Template
        title_designer_page.save_as_name('test_1_1_4', click_ok=1)
    ...
    def test_1_1_5(self):
        ...
        # Select 1st Custom template "test_1_1_4"
        main_page.select_library_icon_view_media('test_1_1_4')
        main_page.double_click()
        time.sleep(DELAY_TIME * 6)

        # [L259] 3.2 Title Designer > Manually adjust on canvas
        ...
        # [L252] 3.2 Title Designer > Object Settings
        ...
        # [L253] 3.2 Title Designer > Object Settings > Ease in / Ease out work
        ...
        # [L258] 3.2 Title Designer > Object Settings > Simple timeline Add / Remove / Switch keyframe
        ...
        # [L254] 3.2 Title Designer > Set in [Object] > Special Effect
        ...
        # scroll down (scroll bar)
        title_designer_page.drag_object_vertical_slider(0.58)
        time.sleep(DELAY_TIME)
        ...
        # Save Template
        title_designer_page.save_as_name('test_1_1_5', click_ok=1)
    ...
    def test_1_1_6(self):
        ...
        # Select 1st Custom template "test_1_1_5"
        main_page.select_library_icon_view_media('test_1_1_5')
        main_page.double_click()
        time.sleep(DELAY_TIME * 6)

        # Current status: Open Title Designer (Advanced) and only unfold "Font / Paragraph"

        # [L255] 3.2 Title Designer > Set Animation > Starting Effect
        with uuid("bb27103b-0bd1-4f73-9eb5-948375335ba1") as case:
            ...
            # Apply In animation: Popup > Pop-up 1
            title_designer_page.select_animation_in_animation_effect(4, 5)
            ...
            is_applied_in_Magnets_ii = not main_page.compare(animation_4_title_preview, no_in_animation_preview,
                                                             similarity=0.96)
            ...
            # Apply In animation: Emerge
            title_designer_page.select_animation_in_animation_effect(8, 2)
            # Preview play > Pause
            main_page.press_space_key()
            ...
            is_applied_in_Counterclockwise = not main_page.compare(animation_3_title_preview, animation_4_title_preview,
                                                                   similarity=0.98)
        ...
        # [L256] 3.2 Title Designer > Set Animation > Ending Effect
        with uuid("df9f83b6-b009-4cbe-9180-2168fd1ad35c") as case:
            ...
            title_designer_page.select_animation_out_animation_effect(6, 6)
            ...
            # Apply Out animation: Shrink
            title_designer_page.select_animation_out_animation_effect(9, 7)
        ...
        # [L257] 3.2 Title Designer > Set Motion
        ...
        # [L260] 3.2 Title Designer > Insert object > Particle
        ...
        # Save Template
        title_designer_page.save_as_name('test_1_1_6', click_ok=1)
    ...
    def test_1_1_7(self):
        ...
        # Select 1st Custom template "test_1_1_5"
        main_page.select_library_icon_view_media('test_1_1_6')
        main_page.double_click()
        time.sleep(DELAY_TIME * 6)
        ...
        # [L262] 3.2 Title Designer > Insert object > Background Image
        with uuid("ea00aff9-e85e-447f-981a-ecd745ad0838") as case:
            ...
            check_BG = not main_page.compare(Ground_Truth_Folder + 'L151_Essential.png', current_image, similarity=0.9)
            ...
            current_image = main_page.snapshot(locator=L.title_designer.area.frame_video_preview)
            check_no_BG = main_page.compare(Ground_Truth_Folder + 'L151_Essential.png', current_image)
            case.result = check_BG and check_no_BG

            # Undo
            title_designer_page.click_undo_btn()

        # [L263] 3.2 Title Designer > Preview > in designer & full screen
        ...
        # [L264] 3.2 Title Designer > Share template DZ (Essential only share to DZ)
        with uuid("441355f4-e673-45fc-b3e4-1b8189a15db8") as case:
            # Click [Share] > Upload to "DZ"
            # Verify DZ link
            ...
            # Essential version does NOT verify content after enter Title room to import DZ template
            # Only verify upload result

            case.result = check_dz_result

        # [L265] 3.2 Title Designer > Save template
        ...
        # [L266] 3.2 Title Designer > Add saved title template to timeline
        ...
        current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_7.pds'
        logger(current_save_project_path)
        ...
        # Can find => Not thing
        # CAN NOT find => delete current saved project : current_save_project_path
        check_explore_file_correct = main_page.is_exist(
            {"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('Test_1_1_7: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_8_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)

        # If test_case_1_1_7 doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_7.pds'):
            logger('CAN NOT find test_case_1_1_7.pds')
            return

        # Open project: test_case_1_1_7
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_7.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')

        # [L275] 3.3 Title Designer (motion graphics title) > Open Title designer
        ...
        # [L276] 3.3 Title Designer (motion graphics title) > Title > Select title track
        ...
        # [L277] 3.3 Title Designer (motion graphics title) > Title > Edit text
        ...
        # [L278] 3.3 Title Designer (motion graphics title) > Able to change group color
        ...
        # [L279] 3.3 Title Designer (motion graphics title) > Object Settings > Position
        ...
        # [L280] 3.3 Title Designer (motion graphics title) > Object Settings > Scale
        with uuid("b30d1cc7-6482-472d-8a2f-382ed7bf011b") as case:
            ...
            if default_h_value == '1.25':
                ...
                logger(default_h_value)

            # Set w = 2.01, h = 3.26
            title_designer_page.mgt.set_scale_width_value('2.10')
        ...
        # [L281] 3.3 Title Designer (motion graphics title) > Object Settings > Rotation
        ...
        # [L282] 3.3 Title Designer (motion graphics title) > Adjust object on preview > Resize
        ...
        # [L284] 3.3 Title Designer (motion graphics title) > Adjust object on preview > Move
        ...
        # [L283] 3.3 Title Designer (motion graphics title) > Adjust object on preview > Rotate
        ...
        # [L285] 3.3 Title Designer (motion graphics title) > Preview in designer
        ...
        # [L286] 3.3 Title Designer (motion graphics title) > Save / Save as template
        ...
        # [L287] 3.3 Title Designer (motion graphics title) > Add saved
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_1_1_8_a',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

        time.sleep(DELAY_TIME * 2)

        current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_8_a.pds'
        logger(current_save_project_path)
        ...
        check_explore_file_correct = main_page.is_exist(
            {"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('test_case_1_1_8_a: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    # 14 uuid
    # BFT 365 version is test_1_1_5
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_9_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)

        # If test_case_1_1_8_a doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_8_a.pds'):
            logger('CAN NOT find test_case_1_1_8_a.pds')
            return

        # Open project: test_case_1_1_8_a
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_8_a.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L289] 3.3 Pip Designer (Dialog_09) > Open PiP designer
        with uuid("4ddeabc0-9f40-4621-bd9a-118beeef450e") as case:
            ...
            # Click [Try for free] w/ untick (don't show again)
            main_page.click_btn_try_for_free()
        ...
        # [L290] 3.3 Pip Designer > Switch to [Advance] mode or [Express] Mode
        ...
        # [L291] 3.3 Pip Designer > Set in [Properties] > Object Setting - Opacity
        ...
        # [L296] 3.3 Pip Designer > Object Setting > Able to add position/scale/opacity/Rotation keyframe with correct value
        ...
        # [L300] 3.3 Pip Designer > Adjust keyframe > Add
        ...
        # [L302] 3.3 Pip Designer > Adjust keyframe > Switch keyframe
        ...
        # [L297] 3.3 Pip Designer > Object Settings > Able to set Ease in/out setting
        ...
        # [L301] 3.3 Pip Designer > Adjust keyframe > Remove
        ...
        # [L305] 3.3 Pip Designer > Set [Motion] > Select Path
        ...
        # [L303] 3.3 Pip Designer > Manual adjust on canvas
        ...
        # [L298] 3.3 Pip Designer > Set in [Properties] > Flip
        ...
        # [L299] 3.3 Pip Designer > Only show the selected track in preview
        ...
        # [L306] 3.3 Pip Designer > Set [Motion Blur]
        ...
        # [L309] 3.4 Pip Designer > Save template
        with uuid("4b3b937e-ce77-4946-8c43-cb1eaaf4a264") as case:
            # Save Template
            main_page.click(L.pip_designer.save_as_button)

            # Check (premium icon)
            check_premium_icon = main_page.is_exist(L.base.try_for_free_dialog.icon_premium)

            # Click [Unlock All]
            if check_premium_icon:
                main_page.click(L.base.try_for_free_dialog.btn_unlock_all)

            web_title = main_page.check_chrome_page()
            logger(web_title)
            logger(web_title.find('Google Chrome'))
            if web_title.find('Google Chrome'):
                verify_essential_method = True
            else:
                verify_essential_method = False

            check_no_gp = main_page.is_exist(L.pip_designer.save_as_button)
            case.result = check_premium_icon and verify_essential_method and check_no_gp
    ...
    def test_1_1_9_b(self):
        ...
        # 3.3 Pip Designer (Mood Stickers 03) > Open PiP designer
        # enter PiP room
        main_page.enter_room(4)
        time.sleep(DELAY_TIME * 3)
        # Select template (21.6.5219 : search then select Mood Sticker 09)
        media_room_page.search_library('Mood Sticker')
        time.sleep(DELAY_TIME * 4)
        main_page.select_library_icon_view_media('Mood Stickers 03')
        # Download IAD template
        time.sleep(DELAY_TIME * 4)
        main_page.right_click()
        main_page.select_right_click_menu('Add to Timeline')
        ...
        # Verify Step: Current enter Pip designer
        get_title = pip_designer_page.get_title()
        if get_title != 'Mood Stickers 03':
            logger(f'Verify NG: Pip Designer title is incorrect {get_title}')
            raise Exception
        ...
        # Click max button / enter full mode
        pip_designer_page.click_maximize_btn()
        time.sleep(DELAY_TIME * 2)

        # [L293] 3.3 Pip Designer > Set in [Properties] > Border
        ...
        with uuid("bad37a4f-6327-42ed-8214-4e245fdaa0a2") as case:
            ...
            after_preview = main_page.snapshot(locator=L.pip_designer.preview,
                                               file_name=Auto_Ground_Truth_Folder + 'L294_Essen_apply_shadow.png')

            # Compare preview is changed when apply Shadow
            compare_result_no_update = main_page.compare(before_preview, after_preview, similarity=0.99)
            logger(compare_result_no_update)

            compare_result_most_the_same = main_page.compare(before_preview, after_preview, similarity=0.9)

            case.result = (not compare_result_no_update) and compare_result_most_the_same

            # Fold shadow menu
            pip_designer_page.express_mode.unfold_properties_shadow_tab(0)
            time.sleep(DELAY_TIME)

        # [L295] 3.3 Pip Designer > Set in [Properties] > Fade
        ...
        # [L292] 3.3 Pip Designer > Set in [Properties] > Chroma Key
        with uuid("3b57839e-be4f-45b4-9cf6-e11bf494a44b") as case:
            ...
            des_pos = (org_pos[0] + size_w * 0.5, org_pos[1] + size_h * 0.5)
            main_page.mouse.click(*des_pos)

            check_preview = main_page.snapshot(locator=L.pip_designer.preview,
                                               file_name=Auto_Ground_Truth_Folder + 'L175_Essential.png')

            # Compare preview after apply chromakey
            compare_result = main_page.compare(Ground_Truth_Folder + 'L175_Essential.png', check_preview)
            logger(compare_result)
        ...
        # [L304] 3.3 Pip Designer > Set Animation
        with uuid("34f35e0f-aff7-46bc-8624-81866440a7f8") as case:
            ...
            # Set timecode (00:00:00:21)
            pip_designer_page.set_timecode('00_00_00_21')
            time.sleep(DELAY_TIME * 3)
            check_preview = main_page.snapshot(locator=L.pip_designer.preview,
                                               file_name=Auto_Ground_Truth_Folder + 'L187_Essential.png')

            # Compare preview after apply chromakey
            compare_result = main_page.compare(Ground_Truth_Folder + 'L187_Essential.png', check_preview, similarity=0.9)
            logger(compare_result)
        ...
        # [L307] 3.3 Pip Designer > Preview in Designer
        with uuid("55666272-8ab9-4b7f-a6b1-dfbf0c6322ad") as case:
            ...
            time.sleep(DELAY_TIME * 3)
            check_preview = main_page.snapshot(locator=L.pip_designer.designer_window,
                                               file_name=Auto_Ground_Truth_Folder + 'L190_Essential.png')

            # Compare preview
            compare_result = main_page.compare(Ground_Truth_Folder + 'L190_Essential.png', check_preview, similarity=0.9)
            logger(compare_result)
        ...
        # [L308] 3.4 Pip Designer > [Share] template online
        with uuid("fbce1533-d0d5-4ca9-9aed-2f0e4ade18c4") as case:
            # Click [Share] > Upload to "Cyberlink Cloud"
            # Verify DZ link

            check_upload = pip_designer_page.share_to_cloud(name='dialog09_chroma', tags='123', collection='test', description='Apply chroma key', only_dz=1)
            logger(check_upload)
        ...
        with uuid("b63cc42d-7ae7-49e8-9584-36d0afb9af10") as case:
            ...
            timeline_preview = main_page.snapshot(locator=main_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'L193_Essential.png')
            check_current_dialog09 = main_page.compare(Ground_Truth_Folder + 'L193_Essential.png', timeline_preview, similarity=0.9)
            case.result = check_current_dialog09

        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_1_1_9_b',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

        time.sleep(DELAY_TIME * 2)

        current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_9_b.pds'
        logger(current_save_project_path)

        # Select range : 9 sec. ~ 21 sec.
        timeline_operation_page.set_range_markin_markout(270, 630)
        time.sleep(DELAY_TIME)
        ...
        check_explore_file_correct = main_page.is_exist(
            {"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('test_case_1_1_9_b: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    # 17 uuid
    # BFT 365 version is test_1_1_6
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_10_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)

        # If test_case_1_1_9_b doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_9_b.pds'):
            logger('CAN NOT find test_case_1_1_9_b.pds')
            return

        # Open project: test_case_1_1_9_b
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_9_b.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')

        # [L323] 3.5 Shape Designer (Shape 10) > Open Shape designer
        ...
        # [L324] 3.5 Shape Designer (Shape 10) > Input text
        ...
        # [L326] 3.5 Shape Designer (Shape 10) > Properties tab > Shape Type (Linear shape)
        ...
        # [L325] 3.5 Shape Designer (Shape 10) > Properties tab > Shape Type (General shape)
        ...
        # [L327] 3.5 Shape Designer (Shape 10) > Properties tab > Preset
        ...
        # [L328] 3.5 Shape Designer (Shape 10) > Properties tab > Fill
        ...
        # [L329] 3.5 Shape Designer (Shape 10) > Properties tab > Outline
        ...
        # [L330] 3.5 Shape Designer (Shape 10) > Properties tab > Shadow
        ...
        # [L331] 3.5 Shape Designer (Shape 10) > Properties tab > Title
        ...
        # [L336] 3.5 Shape Designer (Shape 10) > Manual adjust on canvas
        ...
        # [L333] 3.5 Shape Designer (Shape 10) > Keyframe tab > Adjust keyframe
        with uuid("c70a3ee9-2263-4772-a7d7-d4f859315ec0") as case:
            ...
            check_preview = main_page.snapshot(locator=L.shape_designer.designer_window,
                                               file_name=Auto_Ground_Truth_Folder + 'L205_Essential.png')
            compare_result = main_page.compare(Ground_Truth_Folder + 'L205_Essential.png', check_preview, similarity=0.88)
            case.result = compare_result

        # [L334] 3.5 Shape Designer (Shape 10) > Keyframe tab > Adjust ease in / out
        with uuid("4eda0d6a-b0ea-4100-a22a-317fffdfb976") as case:
            ...
            # Compare preview
            check_preview = main_page.snapshot(locator=L.shape_designer.designer_window,
                                               file_name=Auto_Ground_Truth_Folder + 'L206_ease_in_out_Essential.png')
            compare_result = main_page.compare(Ground_Truth_Folder + 'L205_Essential.png', check_preview, similarity=0.98)
            case.result = not compare_result

        # [L335] 3.5 Shape Designer (Shape 10) > Add keyframe in simple timeline
        ...
        # [L337] 3.5 Shape Designer (Shape 10) > Preview in designer
        ...
        # [L338] 3.5 Shape Designer (Shape 10) > Save as template
        ...
        # [L339] 3.5 Shape Designer (Shape 10) > Add saved template to timeline
        with uuid("ae82fd12-b91f-40e1-ade5-5cca22803e7e") as case:
            ...
            # Compare preview
            check_preview = main_page.snapshot(locator=L.shape_designer.designer_window,
                                               file_name=Auto_Ground_Truth_Folder + 'L211_Essential.png')
            compare_result = main_page.compare(Ground_Truth_Folder + 'L211_Essential.png', check_preview)
        ...
        with uuid("12c35c84-9c7b-4ba1-bcdb-7510d1dc1555") as case:
            ...
            compare_result = main_page.compare(Ground_Truth_Folder + 'L211_Essential.png', check_preview_204)
            logger(compare_result)
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_1_1_10_a',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

        time.sleep(DELAY_TIME * 2)

        current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_10_a.pds'
        logger(current_save_project_path)

        # Select range : 19 sec. ~ 25 sec.
        timeline_operation_page.set_range_markin_markout(570, 750)
        time.sleep(DELAY_TIME)
        ...
        check_explore_file_correct = main_page.is_exist(
            {"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('test_case_1_1_10_a: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    # 6 uuid
    # BFT 365 version is test_1_1_7
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_11_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)

        # If test_case_1_1_10_a doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_10_a.pds'):
            logger('CAN NOT find test_case_1_1_10_a.pds')
            return

        # Open project: test_case_1_1_10_a
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_10_a.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')

        # [L341] 3.6 Particle Designer (Should support opacity) > Open Particle designer
        with uuid("51d8dc04-c9dc-4f8e-b7e2-bfb9e802e19b") as case:
            # enter Particle room
            main_page.enter_room(5)
            time.sleep(DELAY_TIME * 3)
            particle_room_page.search_Particle_room_library('blogger particle')
            time.sleep(DELAY_TIME * 3)

            main_page.select_library_icon_view_media('Blogger Particle 03')
            time.sleep(DELAY_TIME*7)

            # Drag BFT_title_Save to timeline track 2
            main_page.drag_media_to_timeline_playhead_position('Blogger Particle 03', track_no=2)
            ...
            if check_title == 'Blogger Particle 03':
                case.result = True
            else:
                case.result = False

        # [L342] 3.6 Particle Designer (Should support opacity) > modify parameter
        with uuid("56edc685-fdb3-4aa5-9fbb-36060e6a5223") as case:
            ...
            check_preview = main_page.snapshot(locator=L.particle_designer.designer_window,
                                               file_name=Auto_Ground_Truth_Folder + 'L214_Essential.png')
            compare_result = main_page.compare(Ground_Truth_Folder + 'L214_Essential.png', check_preview)

            case.result = check_default and compare_result

        # [L343] 3.6 Particle Designer (Should support opacity) > preview in designer
        ...
        # [L344] 3.6 Particle Designer (Should support opacity) > [Share] template online
        with uuid("6030bf73-af59-4bef-ba28-051b275491ec") as case:
            check_upload = particle_designer_page.share_to_cloud(name='Blogger_Particle_03', tags='test', collection='test', description='art particle design', only_dz=1)
            logger(check_upload)
            ...
            if check_title == 'Blogger_Particle_03':
            ...
            particle_designer_page.save_as_name('Essential_Blogger_Particle_03')
            time.sleep(DELAY_TIME)
            particle_designer_page.save_as_ok()
            particle_designer_page.click_OK()

            case.result = check_upload and upload_save_back

        # [L345] 3.6 Particle Designer (Should support opacity) > Save / Save as template
        with uuid("23140e39-6b80-4d37-b572-266f1481fca1") as case:
            main_page.select_library_icon_view_media('Essential_Blogger_Particle_03')
            check_different = main_page.Check_PreviewWindow_is_different(sec=4)
            logger(check_different)
            case.result = check_different

        # [L346] 3.6 Particle Designer (Should support opacity) > Add saved title template to timeline
        with uuid("5945daf9-f385-471b-aa11-4b9445c4736f") as case:
            ...
            timeline_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view, file_name=Auto_Ground_Truth_Folder + 'L217_Essential.png')
            check_timeline_particle = main_page.compare(Ground_Truth_Folder + 'L217_Essential.png', timeline_preview, similarity=0.8)
            case.result = check_timeline_particle

        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_1_1_11_a',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')
    # 19 uuid
    # BFT 365 version is test_1_1_8
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_12_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)
        ...
        # If test_case_1_1_11_a doesn't exist, return skip
        if not main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_11_a.pds'):
            logger('CAN NOT find test_case_1_1_11_a.pds')
            return

        # Open project: test_case_1_1_11_a
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_1_1_11_a.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L348] 3.7 Mask Designer (Sport 02.jpg) > Open Mask Designer
        ...
        # [L349] 3.7 Mask Designer (Sport 02.jpg) > Apply default mask
        ...
        # [L361] 3.7 Mask Designer (Sport 02.jpg) > Manual adjust on canvas > Move > Operation works fine.
        ...
        # [L350] 3.7 Mask Designer (Sport 02.jpg) > custom mask from image
        with uuid("f244a59e-d7c8-4da3-b94e-65caa7672ca3") as case:
            ...
            # Verify Step2:
            zero_sec_preview = main_page.snapshot(locator=L.mask_designer.mask_designer_window, file_name=Auto_Ground_Truth_Folder + 'L222_Essential.png')
            check_star_mask = main_page.compare(Ground_Truth_Folder + 'L222_Essential.png', zero_sec_preview, similarity=0.93)
        ...
        # [L354] 3.7 Mask Designer (Sport 02.jpg) > Invert mask
        ...
        # [L351] 3.7 Mask Designer (Sport 02.jpg) > Create title mask
        ...
        with uuid("5a933fab-12ff-464c-8551-b16ef67de363") as case:
            ...
            # Verify Step:
            current_preview = main_page.snapshot(locator=L.mask_designer.mask_designer_window, file_name=Auto_Ground_Truth_Folder + 'L232_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L232_Essential.png', current_preview)
            case.result = check_preview

        # [L362] 3.7 Mask Designer (Sport 02.jpg) > Adjust keyframe in simple timeline
        with uuid("ee9c8e69-b7c6-4288-956e-8074c75500d7") as case:
            ...
            # Verify Step:
            current_preview = main_page.snapshot(locator=L.mask_designer.mask_designer_window, file_name=Auto_Ground_Truth_Folder + 'L234_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L234_Essential.png', current_preview)
        ...
        # [L355] 3.7 Mask Designer (Sport 02.jpg) > feather radius
        ...
        # [L357] 3.7 Mask Designer (Sport 02.jpg) > Set in [Object Settings] > Adjust ease in / ease out
        ...
        # [L356] 3.7 Mask Designer (Sport 02.jpg) > Set in [Object Settings] > Adjust keyframe
        ...
        # [L363] 3.7 Mask Designer (Sport 02.jpg) > Check preview
        with uuid("566f1b44-0467-4ba1-ba9c-32c908bd5d9d") as case:
            ...
            # Verify Step:
            current_preview = main_page.snapshot(locator=L.mask_designer.preview_window, file_name=Auto_Ground_Truth_Folder + 'L235_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L235_Essential.png', current_preview)
            case.result = check_preview and check_preview_update

        # [L352] 3.7 Mask Designer (Sport 02.jpg) > Create Brush Mask
        ...
        # [L353] 3.7 Mask Designer (Sport 02.jpg) > Create Selection Mask
        with uuid("bdcee9e2-2f36-4b79-9444-fb6ad8484ebb") as case:
            ...
            # Verify Step:
            current_preview = main_page.snapshot(locator=L.mask_designer.preview_window, file_name=Auto_Ground_Truth_Folder + 'L225_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L225_Essential.png', current_preview, similarity=0.8)
            case.result = check_preview

        # [L359] 3.7 Mask Designer (Sport 02.jpg) > Manual adjust on canvas > Resize
        ...
        # [L364] 3.7 Mask Designer (Sport 02.jpg) > [Share] template online
        with uuid("346b278c-7aa6-4d43-a4b3-c0da5abc1b53") as case:
            # Apply template
            check_upload = mask_designer_page.share_to_cloud(name='mask_custom', tags='123', collection='test', description='move mask', only_dz=1)
            logger(check_upload)
            time.sleep(DELAY_TIME*3)
        ...
        # [L365] 3.7 Mask Designer (Sport 02.jpg) > [OK] / [Save As] template
        ...
        # [L366] 3.7 Mask Designer (Sport 02.jpg) > Add mask template to timeline
        with uuid("7b75d53d-25d6-4cd5-be71-dc622abf75bc") as case:
            ...
            # Verify Step:
            current_preview = main_page.snapshot(locator=main_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'L238_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L238_Essential.png', current_preview)
            case.result = check_preview

        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_1_1_12_a',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

        time.sleep(DELAY_TIME * 2)

        current_save_project_path = Test_Material_Folder + 'BFT_PDR21_Ess/test_1_1_12_a.pds'
        logger(current_save_project_path)

        # Select range : 24 sec. ~ 27 sec 10 frame.
        timeline_operation_page.set_range_markin_markout(720, 820)
        time.sleep(DELAY_TIME)
        ...
        check_explore_file_correct = main_page.is_exist(
            {"AXIdentifier": "CollectionViewItemTextField", "AXValue": explore_file})
        logger('test_1_1_12_a: AT Extra verify produce step result: ')
        logger(check_explore_file_correct)
        if not check_explore_file_correct:
            main_page.delete_custom_file(current_save_project_path)
            logger('[Verify NG] Due to produced clip does not exist, delete current saved project.')
    ...
    # 36 uuid
    # BFT 365 version is test_1_1_9
    # @pytest.mark.skip
    @exception_screenshot
    def test_1_1_13_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)
        ...
        # [L368] 3.8 Video Collage Designer > Open [Video Collage Designer]
        ...
        # [L370] 3.8 Video Collage Designer > Choose layout (Default)
        with uuid("b2eeb6d2-27c9-40f3-91eb-21188f760789") as case:
            # Select layout 7
            video_collage_designer_page.layout.select_layout(7)

            # [L371] 3.8 Video Collage Designer > Import (Image and Video)
        ...
        # [L372] 3.8 Video Collage Designer > Filter options (Video only & color board)
        with uuid("967c9ed2-79d9-4360-b314-5b7a18582f21") as case:
            ...
            # [L373] 3.8 Video Collage Designer > [Auto Fill] button
            with uuid("c38ba371-183f-4214-b115-02ba7d4cd789") as case:
                case.result = check_preview

        # [L381] 3.8 Video Collage Designer > Adjust Border > Size
        ...
        # [L382] 3.8 Video Collage Designer > Adjust Border > Change Color
        ...
        # [L383] 3.8 Video Collage Designer > Adjust Border > Interclip size
        ...
        # [L386] 3.8 Video Collage Designer > Frame animation
        ...
        # [L384] 3.8 Video Collage Designer > Adjust [Border] > Fill type - Uniform color
        ...
        # [L385] 3.8 Video Collage Designer > Adjust [Border] > Fill type - interclip texture
        ...
        # [L388] 3.8 Video Collage Designer > Start clip playback > After frame animation
        ...
        # [L376] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Set duration
        ...
        # [L380] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Remove clip from slot
        ...
        # [L374] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Exchange slot media
        ...
        # [L378] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Mute/ un-mute
        ...
        # [L387] 3.8 Video Collage Designer > Start clip playback > With frame animation
        ...
        # [L375] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Zoom Slider
        ...
        # [L377] 3.8 Video Collage Designer > Edit in Tile (above 4 tiles) > Trim Video
        ...
        # [L390] 3.8 Video Collage Designer > Before/after clip playback > Display color board
        ...
        # [L394] 3.8 Video Collage Designer > Advanced Settings > Playback timing > One after another
        ...
        # [L391] 3.8 Video Collage Designer > Before/after clip playback > Restart playback
        ...
        # [L389] 3.8 Video Collage Designer > Before/after clip playback > Freeze
        ...
        # [L392] 3.8 Video Collage Designer > Advanced Settings > Playback timing > All at once
        ...
        # [L393] 3.8 Video Collage Designer > Advanced Settings > Playback timing > Delay three seconds
        ...
        # [L397] 3.8 Video Collage Designer > Advanced Settings > Match collage duration to > Shortest Clip
        ...
        # [L398] 3.8 Video Collage Designer > Advanced Settings > Match collage duration to > Clip N
        ...
        # [L396] 3.8 Video Collage Designer > Advanced Settings > Match collage duration to > Longest
        ...
        # [L395] 3.8 Video Collage Designer > Advanced Settings > Match collage duration to > All Videos
        ...
        # [L399] 3.8 Video Collage Designer > [Preview] in designer
        ...
        # [L400] 3.8 Video Collage Designer > Advanced Settings > [Save as] Video Collage layout
        ...
        # [L401] 3.8 Video Collage Designer > [Share] template online
        ...
        # [L402] 3.8 Video Collage Designer > Click [OK] to timeline
        with uuid("d8525e33-043e-49ec-8931-81c006580b72") as case:
            ...
            current_0_sec_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                    file_name=Auto_Ground_Truth_Folder + 'L274_0sec_Essential.png')
            check_0_result = main_page.compare(Ground_Truth_Folder + 'L274_0sec_Essential.png', current_0_sec_preview, similarity=0.9)
            ...
            current_9_sec_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                    file_name=Auto_Ground_Truth_Folder + 'L274_9sec_Essential.png')
            check_9_result = main_page.compare(Ground_Truth_Folder + 'L274_9sec_Essential.png', current_9_sec_preview, similarity=0.9)
            logger(check_9_result)

            case.result = check_0_result and check_9_result

        # [L403] 3.8 Video Collage Designer > Back to Designer from tips area [Video Collage] button
        ...
        # [L404] 3.8 Video Collage Designer > Save Project & Pack material
        with uuid("06e25859-e0ac-49f6-b667-bd4dae1342c8") as case:
            ...
            current_17_sec_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                    file_name=Auto_Ground_Truth_Folder + 'L276_17sec_Essential.png')
            check_17_result = main_page.compare(Ground_Truth_Folder + 'L276_17sec_Essential.png', current_17_sec_preview, similarity=0.9)
            logger(check_17_result)

            # Pack project
            pack_result = main_page.top_menu_bar_file_pack_project_materials(project_path=Test_Material_Folder + 'BFT_PDR21_Ess/second_project/')
        ...
        with uuid("ab28eca5-7ac6-451d-953a-ced27c3579e3") as case:
            self.essential_close_and_restart_app()

            # Verify step
            case.result = main_page.select_library_icon_view_media('Mahoroba.mp3')

    # 6 uuid
    # BFT 365 version is test_1_1_10
    #@pytest.mark.skip
    @exception_screenshot
    def test_1_1_14_a(self):
        # launch PDR
        self.start_essential_app()
        time.sleep(DELAY_TIME * 3)
        ...
        # [L526] 5. Produce > Open Recent project
        with uuid("4cc570a7-5122-4edc-880b-1bc832bd6a40") as case:
            # Open recent project
            main_page.top_menu_bar_file_open_recent_projects(Test_Material_Folder + 'BFT_PDR21_Ess/second_project.pdk')
            time.sleep(DELAY_TIME*3)
            # Select extract path
            main_page.delete_folder(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_2')
            time.sleep(DELAY_TIME)
            main_page.select_file(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_2')
            time.sleep(DELAY_TIME*5)
            main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
            time.sleep(DELAY_TIME*3)
            ...
            current_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view, file_name=Auto_Ground_Truth_Folder + 'L389_Essential.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L389_Essential.png', current_preview, similarity=0.9)
            logger(check_preview)
            case.result = check_preview


        # [L527] 5. Produce > H.264 AVC > Format : M2TS
        ...
        # [L528] 5. Produce > H.264 > Format : 1280x720/24p
        ...
        # [L529] 5. Produce > H.264 > Select encode type (HW)
        ...
        # [L394] 5. Produce > H.264 > Start [Produce]
        with uuid("7849c8fe-7f00-4830-a9a3-bf15ffc129da") as case:
            ...
            if current_last_frame == '00:00:32:00':
            ...
            # Verify step1: Find the "Remove Watermark" button
            check_essential_btn = main_page.is_exist(L.produce.btn_remove_watermark)
            logger(check_essential_btn)
            ...
            case.result = check_explore_file  and check_essential_btn
        ...
        with uuid("5143f3c6-d5a5-4414-90ff-f4bdb3722454") as case:
            ...
            time.sleep(DELAY_TIME * 2)
            # Check preview with timeline timecode = (00:00:11:23)
            current_preview = main_page.snapshot(locator=main_page.area.preview.main,file_name=Auto_Ground_Truth_Folder + 'L389_ess_watermark.png')
            check_2_preview = main_page.compare(Ground_Truth_Folder + 'L389_ess_watermark.png', current_preview, similarity=0.9)
    ...
    # 8 uuid
    # BFT 365 version is test_1_1_11
    #@pytest.mark.skip
    @exception_screenshot
    def test_2_1(self):
        # launch PDR
        ...
        # [L92] 2.1 Media Room > My Project > Open project
        ...
        # [L96] 2.1 Media Room > My Project > Nested project editing
        ...
        # [L98] 2.1 Media Room > Insert clip to timeline & preview (4:3)
        ...
        # [L97] 2.1 Media Room > Insert clip to timeline & preview > Able to insert clip to selected track
        ...
        # [L94] 2.1 Media Room > My Project > Context menu > Add to tag fine
        ...
        # [L101] 2.1 Media Room > Insert clip to timeline & preview > Enable volume meter (form View menu)
        ...
        # [L99] 2.1 Media Room > Insert clip to timeline & preview > Project aspect ratio 9:16
        ...
        # [L100] 2.1 Media Room > Insert clip to timeline & preview > Project aspect ratio 1:1
    ...
    # 23 uuid
    # BFT 365 version is test_1_1_12
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_1(self):
        ...
        # [L50] 2.1 Media Room > Import  > Download fom Stock Content
        ...
        # [L48] 2.1 Media Room > Media Content > Import > Local (File can import correctly by import button)
        ...
        # [L41] 2.1 Media Room > Enable Library preview window
        ...
        # [L42] 2.1 Media Room > Library preview window > Playback Controls
        ...
        # [L45] 2.1 Media Room > Library preview window > Undock
        ...
        # [L44] 2.1 Media Room > Library preview window > Able to add marker
        ...
        # [L43] 2.1 Media Room > Library preview window > Able to Mark in / out then insert timeline
        ...
        # [L46] 2.1 Media Room > Library preview window > Minimize window
        with uuid("4cc511f4-4fb7-4de7-8ef0-7982c3305ef9") as case:
            case.result = library_preview_page.library_preview_click_minimize()

        # [L47] 2.1 Media Room > Library preview window > Disable library preview window
        ...
        # [L60] 2.1 Media Room > Search > Keyword
        ...
        # [L61] 2.1 Media Room > Search > Cancel search
        ...
        # [L66] 2.1 Media Room > Explorer view
        ...
        # [L69] 2.1 Media Room > Tag clip to custom tag
        ...
        # [L70] 2.1 Media Room > Color Board > Uniform color
        ...
        # [L72] 2.1 Media Room > Color Board > Insert to timeline and change color
        ...
        # [L71] 2.1 Media Room > Color Board > Gradient color
        ...
        # [L73] 2.1 Media Room > Color Board > Insert to timeline and change color
        ...
        # [L90] 2.1 Media Room > Downloaded > Downloaded file display correctly
        ...
        # [L91] 2.1 Media Room > My Project > Open / Save project > Show project thumb after save project
        ...
        # [L93] 2.1 Media Room > My Project > Context menu > Open file location correctly
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_3_1',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 6 uuid
    # BFT 365 version is test_1_1_13
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_2(self):
        # launch PDR
        ...
        # Open test_case_3_1 project
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_3_1.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')

        # If open file with file missing, immediately return
        if self.open_project_occurred_file_missing():
            logger('Open project occurred file missing')
            return

        # [L105] 2.2 Intro Video Room > Template display
        ...
        # [L106] 2.2 Intro Video Room > Category display
        ...
        # [L107] 2.2 Intro Video Room > My profile
        with uuid("9f19ce26-268c-4255-9467-033156ceb53f") as case:
            ...
            # Verify Step:
            profile_preview = main_page.snapshot(locator=L.intro_video_room.my_profile.main_window, file_name=Auto_Ground_Truth_Folder + 'L60_Essential.png')
            check_result = main_page.compare(Ground_Truth_Folder + 'L60_Essential.png', profile_preview, similarity=0.8)
            case.result = check_result

            # Close My profile
            main_page.press_esc_key()

        # [L108] 2.2 Intro Video Room > Open Intro Video Designer
        with uuid("eae9c5b2-b7b1-4cc9-99b0-8953963a869a") as case:
            ...
            current_preview = intro_video_page.snapshot(locator=L.intro_video_room.intro_video_designer.preview_area,
                                                   file_name=Auto_Ground_Truth_Folder + 'L61_Essential_replace_Video.png')

            check_result = main_page.compare(Ground_Truth_Folder + 'L61_Essential_replace_Video.png', current_preview)
            case.result = check_result and check_trim_result
            logger(check_result)
            logger(check_trim_result)
        ...
        # [L109] 2.2 Intro Video Room > Add template to timeline > Right click menu
        ...
        # [L110] 2.2 Intro Video Room > Add template to timeline > Tips Area button
        with uuid("0fb947c2-c718-4b81-8bed-7e0a78a84c33") as case:
            ...
            current_timeline = main_page.snapshot(locator=main_page.area.preview.main, file_name=Auto_Ground_Truth_Folder + 'L63_Essential.png')
            check_result = main_page.compare(Ground_Truth_Folder + 'L63_Essential.png', current_timeline)
            case.result = check_result
            ...
            # Save project:
            main_page.top_menu_bar_file_save_project_as()
            main_page.handle_save_file_dialog(name='test_case_3_2',
                                              folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 5 uuid
    # BFT 365 version is test_1_1_14
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_3(self):
        # launch PDR
        ...
        # Open project: test_case_3_2
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_3_2.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L134] 2.3 Title Room > Designer Entry > Modify Title template
        with uuid("2e04cf5c-c013-4165-97b5-30463bf82f88") as case:
            ...
            # Only fixing the Free title / Premium animation issue (Windshield has premium animation) >>---
            # switch to advanced mode
            title_designer_page.switch_mode(2)
            time.sleep(DELAY_TIME * 2)
            ...
            # drag scroll bar to top
            title_designer_page.drag_animation_vertical_slider(0)
            time.sleep(DELAY_TIME * 2)
            # Apply In animation: Popup > Pop-up I
            title_designer_page.select_animation_in_animation_effect(4, 5)
        ...
        # [L118] 2.3 Title Room > Add Built-In templates to timeline & Preview >  Motion Graphic 007, Clover_04, Windshield
        ...
        # [L122] 2.3 Title Room > Add Built-In templates to timeline & Preview >  Maple
        ...
        # [L137] 2.3 Particle Room > Designer Entry > Modify Particle template
        ...
        # [L120] 2.3 Add build-in template to timeline > Effect : back light, Analog film
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_3_3',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 4 uuid
    # BFT 365 version is test_1_1_15
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_4(self):
        # launch PDR
        ...
        # Open project: test_case_3_3
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_3_3.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L85] 2.1 Media Room > Background Music / Sound Clips > Sample preview
        ...
        # [L86] 2.1 Media Room > Background Music / Sound Clips > Download
        ...
        # [L87] 2.1 Media Room > Background Music / Sound Clips > Timeline preview
        with uuid("a29435e4-7b6a-4942-abfd-1a57ec862f6a") as case:
            ...
            # Build (v22.0.5825 Premium feature update)
            # Click [Try for free] w/ untick (don't show again)
            main_page.click_btn_try_for_free()
            time.sleep(DELAY_TIME * 3)
        ...
        # [L88] 2.1 Media Room > Background Music / Sound Clips > Delete from Disk
        with uuid("8312130f-2873-4609-8cb7-4b4ed2dd3cc9") as case:
            ...
            media_room_page.select_specific_category('Musical Jingles')

            media_room_page.sound_clips_select_media('Grudge of the Dead')
            time.sleep(DELAY_TIME * 2)
            main_page.right_click()
            time.sleep(DELAY_TIME)
            main_page.select_right_click_menu('Download')
            time.sleep(DELAY_TIME * 5)
            sound_download_icon = media_room_page.background_music_check_download_mark('Grudge of the Dead')
    ...
    # 4 uuid
    # BFT 365 version is test_1_1_16
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_5(self):
        # launch PDR
        ...
        # [L121] 2.3 Pip Room > Shape 017, Dialog_07, Wedding_2
        with uuid("c805bedd-ee5f-4a40-9476-be67a8c75ccb") as case:
            ...
            main_page.exist_click(L.media_room.input_search)
            main_page.keyboard.send('Mood stickers 31')
            main_page.press_enter_key()
            time.sleep(DELAY_TIME * 3)

            # Insert to timeline (Track 2)
            main_page.select_library_icon_view_media('Mood Stickers 31')
            time.sleep(DELAY_TIME * 6)
            main_page.right_click()
            main_page.select_right_click_menu('Add to Timeline')
            ...
            shape_dialog_preview = main_page.snapshot(locator=main_page.area.preview.main,
                                                        file_name=Auto_Ground_Truth_Folder + 'L68_shape_moon_31.png')
            shape_dialog_result = main_page.compare(Ground_Truth_Folder + 'L68_shape_moon_31.png', shape_dialog_preview)

            case.result = shape_wedding_result and shape_dialog_result

        # [L136] 2.3 Pip Room > Designer entry > Shape template can modify (Shape 017)
        ...
        # [L135] 2.3 Pip Room > Designer entry > Pip template can modify (Wedding 2)
        ...
        # [L119] 2.3 Transition Room > Binary 1
        with uuid("8d6fe590-d4af-4ac4-8e7d-e7e4295d4a17") as case:
            ...
            # Insert (Binary 1) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Binary 1', 'Mood Stickers 31')

            main_page.set_timeline_timecode('00_00_00_28')
            time.sleep(DELAY_TIME * 2)

            binary_1_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                        file_name=Auto_Ground_Truth_Folder + 'L66_binary_Ess.png')
            check_result_01 = main_page.compare(Ground_Truth_Folder + 'L66_binary_Ess.png', binary_1_preview, similarity=0.9)
            ...
            # Insert (Blur) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Blur', 'Mood Stickers 31')

            main_page.set_timeline_timecode('00_00_00_17')
            time.sleep(DELAY_TIME * 2)

            blur_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                        file_name=Auto_Ground_Truth_Folder + 'L66_blur_Ess.png')
            check_result_02 = main_page.compare(Ground_Truth_Folder + 'L66_blur_Ess.png', blur_preview)
            ...
            # Insert (Brush Transition 01) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Brush Strokes 01', 'Mood Stickers 31')

            main_page.set_timeline_timecode('00_00_00_28')
            time.sleep(DELAY_TIME * 2)

            binary_1_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                  file_name=Auto_Ground_Truth_Folder + 'L66_brush_01_Ess.png')
            check_result_03 = main_page.compare(Ground_Truth_Folder + 'L66_brush_01_Ess.png', binary_1_preview)
            ...
            # Insert (Cross 2) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Cross 2', 'Mood Stickers 31')

            main_page.set_timeline_timecode('00_00_00_13')
            time.sleep(DELAY_TIME * 2)

            cross_2_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                  file_name=Auto_Ground_Truth_Folder + 'L66_cross_Ess.png')
            check_result_04 = main_page.compare(Ground_Truth_Folder + 'L66_cross_Ess.png', cross_2_preview)
            ...
            # Insert (Magnify) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Magnify', 'Mood Stickers 31')

            main_page.set_timeline_timecode('00_00_01_00')
            time.sleep(DELAY_TIME * 2)

            magnify_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                  file_name=Auto_Ground_Truth_Folder + 'L66_magnify_Ess.png')
            check_result_05 = main_page.compare(Ground_Truth_Folder + 'L66_magnify_Ess.png', magnify_preview)
            ...
            # Insert (Magnify) to (Wedding 2) and (Mood Stickers 31)
            main_page.drag_transition_to_timeline_clip('Disturbance', 'Mood Stickers 31')
            ...
            disturbance_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                  file_name=Auto_Ground_Truth_Folder + 'L66_disturbance_Ess.png')
            check_result_06 = main_page.compare(Ground_Truth_Folder + 'L66_disturbance_Ess.png', disturbance_preview, similarity=0.7)
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_3_5',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 9 uuid
    # BFT 365 version is test_1_1_17
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_6(self):
        # launch PDR
        ...
        # Open project: test_case_3_5
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_3_5.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L124] 2.3 Transition / Effect / Particle Room > IAD: Transition, Effect, Particle
        with uuid("0941636d-0f13-4fbf-baa8-e2725af12a32") as case:
            ...
            main_page.exist_click(L.media_room.input_search)
            main_page.keyboard.send('Fitness Particle 01')
            main_page.press_enter_key()
            time.sleep(DELAY_TIME * 3)

            # Download IAD: Instant Memories
            main_page.select_library_icon_view_media('Fitness Particle 01')
            time.sleep(DELAY_TIME * 5)

            # Insert (Instant Memories) to track 1
            main_page.drag_media_to_timeline_playhead_position('Fitness Particle 01', track_no=1)

            # Enter Transition Room ---------
            main_page.enter_room(2)
            time.sleep(DELAY_TIME * 2)

            # Input search Sparkle Transitions 07 ---------
            main_page.exist_click(L.media_room.input_search)
            main_page.keyboard.send('Sparkle Transitions 07')
            main_page.press_enter_key()
            time.sleep(DELAY_TIME * 3)

            # Download IAD: Instant Memories
            main_page.select_library_icon_view_media('Sparkle Transitions 07')
            time.sleep(DELAY_TIME * 5)

            # Insert Transition (Snow 03) to (Dialog_07) and (Instant Memories)
            main_page.drag_transition_to_timeline_clip('Sparkle Transitions 07', 'Fitness Particle 01')

            main_page.set_timeline_timecode('00_00_00_27')
            time.sleep(DELAY_TIME * 2)

            transition_IAD_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view,
                                                  file_name=Auto_Ground_Truth_Folder + 'L71_transition_IAD_Ess.png')
            check_result_01 = main_page.compare(Ground_Truth_Folder + 'L71_transition_IAD_Ess.png', transition_IAD_preview, similarity=0.9)
            ...
            # Input search lens flare 39 ---------
            main_page.exist_click(L.media_room.input_search)
            main_page.keyboard.send('lens flare 39')
            main_page.press_enter_key()
            time.sleep(DELAY_TIME * 3)

            # Download IAD: Lens Flare 39
            main_page.select_library_icon_view_media('Lens Flare 39')
            time.sleep(DELAY_TIME * 5)
            ...
            effect_IAD_preview = main_page.snapshot(locator=main_page.area.preview.main,
                                                  file_name=Auto_Ground_Truth_Folder + 'L71_flare_39.png')
            check_result_02 = main_page.compare(Ground_Truth_Folder + 'L71_flare_39.png', effect_IAD_preview, similarity=0.9)

            case.result = check_result_01 and check_result_02

        # [L126] 2.3 Effect Room > Import LUT Effect
        with uuid("5e5419f2-bdb1-4664-933c-753b9c640682") as case:
            ...
            lut_3dl_preview = main_page.snapshot(locator=main_page.area.preview.main,
                                                  file_name=Auto_Ground_Truth_Folder + 'L72_3dl_Ess.png')
            case.result = main_page.compare(Ground_Truth_Folder + 'L72_3dl_Ess.png', lut_3dl_preview)
        ...
        # [L187] 2.4 Audio Mixing Room > Audio Track
        ...
        # [L188] 2.4 Audio Mixing Room > Video volume slider
        ...
        # [L189] 2.4 Audio Mixing Room > Volume meter (meter should change during preview)
        ...
        # [L192] 2.4 Audio Mixing Room > Volume meter > Stereo
        ...
        # [L190] 2.4 Audio Mixing Room > Audio gain slider
        ...
        # [L191] 2.4 Audio Mixing Room > Fade in / Fade out
        ...
        # [L194] 2.4 Audio Mixing Room > Add / Remove/ Switch keyframe
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_case_3_6',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 11 uuid
    # BFT 365 version is test_1_1_20
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_7(self):
        # launch APP
        ...
        # [L206] 2.6 Subtitle Room > Subtitle room should be gray out when not clips on timeline
        ...
        # Open project: test_case_3_6
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_case_3_6.pds')
        main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L208] 2.6 Subtitle Room > Create Subtitle manually
        ...
        # [L209] 2.6 Subtitle Room > Input text
        ...
        # [L212] 2.6 Subtitle Room > Adjust subtitle position
        ...
        # [L210] 2.6 Subtitle Room > Merge / Split subtitle
        ...
        # [L213] 2.6 Subtitle Room > Change subtitle text format
        ...
        # [L215] 2.6 Subtitle Room > Preview movie
        ...
        # [L214] 2.6 Subtitle Room > EXport & Import subtitle
        with uuid("381ba551-3de8-4d4f-b5f0-2c00938a7f29") as case:
            srt_export_folder = Test_Material_Folder + 'BFT_PDR21_Ess/Export/additional_font/'
        ...
        with uuid("4c2bfca6-2351-4925-ba94-9af00253b738") as case:
            # Pack project
            pack_result = main_page.top_menu_bar_file_pack_project_materials(project_path=Test_Material_Folder + 'BFT_PDR21_Ess/first_project/')
    ...
    # 8 uuid
    # BFT 365 version is test_1_1_21
    #@pytest.mark.skip
    @exception_screenshot
    def test_3_8(self):
        # launch APP
        ...
        # [L517] 5. Produce > XAVCS > Open Saved project
        with uuid("8d2e8c7e-3108-4cfa-bcf8-bb37446caa2a") as case:
            # Open project: first_project
            main_page.top_menu_bar_file_open_project(save_changes='no')
            check_open_result = main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/first_project.pdk')
            time.sleep(DELAY_TIME*3)
            if not check_open_result:
                ...
                # Select extract path
                main_page.delete_folder(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_1')
                time.sleep(DELAY_TIME)
                main_page.select_file(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_1')
                time.sleep(DELAY_TIME*5)
                main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
                time.sleep(DELAY_TIME*3)
        ...
        # [L518] 5. Produce > XAVCS > Select [Format] > XAVCS
        ...
        # [L519] 5. Produce > XAVCS > Select [Format] > 1280x720/30p (17Mbps)
        ...
        # [L520] 5. Produce > XAVCS > Select encode type > SW
        ...
        # [L522] 5. Produce > XAVCS > Set [Surround Sound] > TT Surround
        ...
        # [L523] 5. Produce > XAVCS > Set output folder and file name
        with uuid("0092cf6f-fc69-455b-b4f1-558b992e2ee5") as case:
            ...
            time.sleep(DELAY_TIME)
            if main_page.exist_file(Test_Material_Folder + 'BFT_PDR21_Ess/produce/L386_xavc.mp4'):
                main_page.delete_folder(Test_Material_Folder + 'BFT_PDR21_Ess/produce')

            produce_page.select_output_folder(Test_Material_Folder + 'BFT_PDR21_Ess/produce/L386_xavc.mp4')
            time.sleep(DELAY_TIME*2)
        ...
        # [L524] 5. Produce > XAVCS > Start Produce
        ...
        # [L525] 5. Produce > XAVCS > Playback produced clip
        with uuid("b8960b0f-b0f8-4451-b163-12501bca2c9c") as case:
            ...
            # Verify Step:
            # Set timeline timecode = (00:00:55:02)
            main_page.set_timeline_timecode('00_00_55_02')
            time.sleep(DELAY_TIME * 3)
            # Check preview with timeline timecode = (00_00_55_02)
            current_preview = main_page.snapshot(locator=L.base.Area.preview.only_mtk_view, file_name=Auto_Ground_Truth_Folder + 'L388_Ess.png')
            check_preview = main_page.compare(Ground_Truth_Folder + 'L388_Ess.png', current_preview, similarity=0.9)
            logger(check_preview)
            case.result = check_preview

    # 5 uuid
    # BFT 365 version is test_1_1_18
    #@pytest.mark.skip
    @exception_screenshot
    def test_4_1(self):
        # launch PDR
        ...
        # [L193] 2.4 Audio Mixing Room > Volume meter > 5.1 Surround
        ...
        # [L195] 2.4 Audio Mixing Room > Normalize
        ...
        # [L203] 2.5 Voice Over Recording Room > Recording
        ...
        # [L197] 2.5 Voice Over Recording Room > Recording preference > Time limit
        ...
        # [L204] 2.5 Voice-Over recording Room > Stop record
    ...
    # 5 uuid
    # BFT 365 version is test_1_1_19
    #@pytest.mark.skip
    @exception_screenshot
    def test_4_2(self):
        # launch PDR
        ...
        # [L199] 2.5 Voice-Over recording Room > Recording Preference > auto fade-in
        ...
        # [L200] 2.5 Voice-Over recording Room > Recording Preference > auto fade-out
        ...
        # [L201] 2.5 Voice-Over recording Room > Mute all tracks when recording
        ...
        # [L198] 2.5 Voice-Over recording Room > Auto 3 sec delay before recording
        ...
        # [L207] 2.6 Subtitle Room > Speech to text (Auto Transcribe subtitle)
    ...
    # 3 uuid
    # BFT 365 version is test_1_1_26
    # @pytest.mark.skip
    @exception_screenshot
    def test_4_3(self):
        # launch PDR
        ...
        # [L429] 4.2 Tools > Audio Smart Fit for Duration > Remix audio
        ...
        # [L430] 4.2 Tools > Audio Smart Fit for Duration > Preview
        ...
        # [L431] 4.2 Tools > Audio Smart Fit for Duration > Apply result to timeline clip correctly
    ...
    # BFT 365 version is test_1_1_28
    # @pytest.mark.skip
    @exception_screenshot
    def test_4_4(self):
        # launch APP
    ...
    # 8 uuid
    # BFT 365 version is test_1_1_29
    #@pytest.mark.skip
    @exception_screenshot
    def test_5_1(self):
        # launch PDR
        ...
        # [L440] 4.2 Tools > Motion Tracker > Object Tracking
        ...
        # [L441] 4.2 Tools > Motion Tracker > Add Text Object
        ...
        # [L442] 4.2 Tools > Motion Tracker > Add Pip Object
        ...
        # [L444] 4.2 Tools > Motion Tracker > Preview
        ...
        # [L443] 4.2 Tools > Motion Tracker > Add Effect
        ...
        # [L445] 4.2 Tools > Motion Tracker > Apply and return to timeline
        ...
        # [L476] 4.4 Keyframe > Fix Enhance > Lighting Adjustment (Degree)
        ...
        # [L481] 4.4 Keyframe > Fix Enhance > White Balance
    ...
    # 8 uuid
    # BFT 365 version is test_1_1_30
    #@pytest.mark.skip
    @exception_screenshot
    def test_5_2(self):
        # launch PDR
        ...
        # [L248] 3.2 Title Designer (general template) > Set in [Object] > Font Face with Gradient Color
        ...
        # [L463] 4.3 Fix/ Enhance > Fix > Wind Removal
        ...
        # [L462] 4.3 Fix/ Enhance > Fix > Apply [Audio Denoise]
        ...
        # [L542] 5.1 Produce 2D > Audio File > Select [Format] > AIFF
        ...
        # [L540] 5.1 Produce 2D > Audio File > Select [Format] > M4A
        ...
        # [L541] 5.1 Produce 2D > Audio File > Select [Format] > WAV
        ...
        # [L478] 4.4 Keyframe > Fix/ Enhance > Fix > Adjust [Audio Denoise]
    ...
    # 9 uuid
    # BFT 365 version is test_1_1_22
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_1(self):
        # launch PDR
        ...
        # [L408] 4.1 Basic > Trim > Entry (from Precut)
        ...
        # [L410] 4.1 Basic > Trim type > Single Trim
        ...
        # [L409] 4.1 Basic > Entry > Tips area > Trim
        ...
        # [L411] 4.1 Basic > Tips type > Multi Trim
        ...
        # [L412] 4.1 Basic > Trim > Preview trimmed clip in timeline
        ...
        # [L413] 4.1 Basic > Crop > Open [Crop Image] window
        ...
        with uuid("cdfdf12d-cbe7-46bd-80d1-044f5afa6ec7") as case:
            ...
            # Save project:
            main_page.top_menu_bar_file_save_project_as()
            main_page.handle_save_file_dialog(name='test_6_1',
                                              folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 11 uuid
    # BFT 365 version is test_1_1_23
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_2(self):
        # launch PDR
        ...
        # Open project: test_6_1
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_1.pds')
        ...
        # [L418] 4.2 > Tools > Pan & Zoom (image) > [Pan & Zoom] page > UI switch to Pan & Zoom
        ...
        # [L419] 4.2 > Tools > Pan & Zoom (image) > [Pan & Zoom] page > Select style
        ...
        # [L420] 4.2 > Tools > Pan & Zoom (image) > [Pan & Zoom] page > Apply to all
        ...
        # [L421] 4.2 > Tools > Pan & Zoom (image) > Magic Motion Designer > Adjust position / scale / Rotate
        ...
        # [L423] 4.2 > Tools > Pan & Zoom (image) > Magic Motion Designer > Preview
        ...
        # [L424] 4.2 > Tools > Pan & Zoom (image) > Magic Motion Designer > Apply (check timeline preview)
        ...
        # [L422] 4.2 > Tools > Pan & Zoom (image) > Magic Motion Designer > Reset
        ...
        # [L425] 4.2 > Tools > Crop / Zoom / Pan > Adjust position / scale / rotation
        ...
        # [L427] 4.2 > Tools > Crop / Zoom / Pan > Preview
        ...
        # [L428] 4.2 > Tools > Crop / Zoom / Pan > Apply (Check timeline preview after apply)
        ...
        # [L426] 4.2 > Tools > Crop / Zoom / Pan > Reset
        with uuid("d4ea74c3-f6d6-4e49-be46-c0b9d452c447") as case:
            ...
            # Save project:
            main_page.top_menu_bar_file_save_project_as()
            main_page.handle_save_file_dialog(name='test_6_2',
                                              folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 6 uuid
    # BFT 365 version is test_1_1_24
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_3(self):
        # launch PDR
        ...
        # Open project: test_6_2
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_2.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        ...
        # [L432] 4.2 Tools > Video Speed > Entire Clip > Adjust from new video duration
        ...
        # [L433] 4.2 Tools > Video Speed > Entire Clip > Adjust Speed multiplier
        ...
        # [L434] 4.2 Tools > Video Speed > Selected Range > Create a time shift
        ...
        # [L435] 4.2 Tools > Video Speed > Selected Range > Adjust speed (1.5x)
        ...
        # [L436] 4.2 Tools > Video Speed > Reset
        ...
        # [L437] 4.2 Tools > Video Speed > Preview
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_6_3',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')

    # 8 uuid
    # BFT 365 version is test_1_1_25
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_4(self):
        # launch PDR
        ...
        # Open project: test_6_3
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_3.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        ...
        # [L447] 4.2 Tools > Blending Mode > Image
        ...
        # [L446] 4.2 Tools > Blending Mode > Video
        ...
        # [L438] 4.2 Tools > Video / Audio in Reverse > Tick
        ...
        # [L439] 4.2 Tools > Video / Audio in Reverse > UnTick
        ...
        # [L450] 4.2 Tools > Audio Editor > Set Channel
        ...
        # [L449] 4.2 Tools > Audio Editor > Apply each adjustment function
        ...
        # [L451] 4.2 Tools > Audio Editor > Check Preview
        ...
        # [L453] 4.2 Tools > Audio Editor > Apply (Result is correct in timeline after apply)
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_6_4',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')
        time.sleep(DELAY_TIME*3)

    # 9 uuid
    # BFT 365 version is test_1_1_27
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_5(self):
        # launch PDR
        ...
        # Open project: test_6_4
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_4.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        ...
        # [L455] 4.3 Fix / Enhance > Enter [Fix / Enhance] page with each clip
        ...
        # [L457] 4.3 Fix / Enhance > Fix > Apply [Lighting Adjustment]
        ...
        # [L458] 4.3 Fix / Enhance > Fix > Apply [White Balance]
        ...
        # [L470] 4.3 Fix / Enhance > Compare in split preview
        ...
        # [L464] 4.3 Fix / Enhance > Enhance > Apply [Color Adjustment]
        ...
        # [L467] 4.3 Fix / Enhance > Enhance > Apply [Split Toning]
        ...
        # [L456] 4.3 Fix / Enhance > Enter [Fix / Enhance] w/ Image clip
        ...
        # [L460] 4.3 Fix / Enhance > Fix > Apply Lens Correction
        ...
        # [L468] 4.3 Fix / Enhance > Enhance > Apply HDR Effect
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_6_5',
                                          folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')
        time.sleep(DELAY_TIME*3)

    # 12 uuid
    # BFT 365 version is test_1_1_31
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_6(self):
        # launch PDR
        ...
        # Open project: test_6_5
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_5.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        time.sleep(DELAY_TIME * 5)
        ...
        # [L482] 4.4 Keyframe > Fix / Enhance > Adjust [Split Toning]
        ...
        # [L479] 4.4 Keyframe > Fix / Enhance > Adjust [Color Adjustment]
        ...
        # [L484] 4.4 Keyframe > Clip Attribute > Position
        ...
        # [L488] 4.4 Keyframe > Clip Attribute > Freeform
        with uuid("85a485fe-c64b-430a-8cd2-64bc82e15822") as case:
            ...
            # click next keyframoe of freeform
        ...
        # [L487] 4.4 Keyframe > Clip Attribute > Rotate
        ...
        # [L486] 4.4 Keyframe > Clip Attribute > Opacity
        ...
        # [L485] 4.4 Keyframe > Clip Attribute > Scale
        ...
        # [L490] 4.4 Keyframe > Preview adjustment
        ...
        # [L483] 4.4 Keyframe > Fix Enhance > Adjust [HDR Effect]
        ...
        # [L491] 4.4 Keyframe > Save as Project
        with uuid("77a67c4a-2f74-47bf-b5bc-31defc5d3280") as case:
            # Save project:
            main_page.top_menu_bar_file_save_project_as()
            check_save_result = main_page.handle_save_file_dialog(name='test_6_6',
                                              folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')
            time.sleep(DELAY_TIME*2)
            ...
            elif main_page.exist(L.base.main_caption).AXValue == 'test_6_6':
    ...
    # 6 uuid
    # BFT 365 version is test_1_1_32
    #@pytest.mark.skip
    @exception_screenshot
    def test_6_7(self):
        # clear AI module
        ...
        # Open project: test_6_6
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_6.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        time.sleep(DELAY_TIME * 5)
        ...
        # [L461] 4.3 Fix / Enhance > Fix > Apply [Video Denoise]
        ...
        # [L477] 4.4 Keyframe > Fix / Enhance > Adjust [Video Denoise]
        ...
        # [L465] 4.3 Fix / Enhance > Enhance > Apply [Color Enhancement]
        ...
        # [L480] 4.4 Keyframe > Fix / Enhance > Adjust [Color Enhancement]
        ...
        # [L469] 4.3 Fix / Enhance > Enhance > Speech Enhancement
        ...
        # [L459] 4.3 Fix / Enhance > Fix > Video Stabilizer
        ...
        # Save project:
        main_page.top_menu_bar_file_save_project_as()
        main_page.handle_save_file_dialog(name='test_6_7', folder_path=Test_Material_Folder + 'BFT_PDR21_Ess/')
        time.sleep(DELAY_TIME * 5)

        # Pack project:
        # 2023/10/30: v22.0.5825 Cannot pack project normally (Due to Essential account apply Video Denoise >> need to upgrade 365)
        # main_page.top_menu_bar_file_pack_project_materials(project_path=Test_Material_Folder + 'BFT_PDR21_Ess/third_project/')
        # wait pack project processing ready
        #time.sleep(DELAY_TIME * 15)

    # 7 uuid
    # BFT 365 version is test_1_1_33
    # @pytest.mark.skip
    @exception_screenshot
    def test_6_8(self):
        # launch PDR
        ...
        # Open project: test_6_7
        main_page.top_menu_bar_file_open_project(save_changes='no')
        main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/test_6_7.pds')
        main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
        time.sleep(DELAY_TIME * 5)
        ...
        # [L495] 4.5 Timeline operation > Range selection > Remove
        ...
        # [L494] 4.5 Timeline operation > Range selection > Cut
        ...
        # [L501] 4.5 Timeline operation > Ripple Editing > Trim to Fit (video only)
        with uuid("d3561515-1f17-4fd9-8a74-4f8fab04e604") as case:
            ...
            main_page.select_library_icon_view_media('Skateboard 03.mp4')
            case.result = tips_area_page.click_TipsArea_btn_insert(5)

        # [L502] 4.5 Timeline operation > Ripple Editing > Speed up to Fit (video only)
        ...
        # [L500] 4.5 Timeline operation > Ripple Editing > Overwrite
        ...
        # [L496] 4.5 Timeline operation > Range Selection > Render Preview
        ...
        # [L499] 4.5 Timeline operation > Range Selection > Lock Range
    ...
    # 1 uuid
    # BFT 365 version is test_1_1_33 (Part 2) for bug regression
    # @pytest.mark.skip
    @exception_screenshot
    def test_6_8_b(self):
        # launch PDR
        ...
        #  4.5 Timeline operation > Range selection > Remove
        timeline_operation_page.set_range_markin_markout(30, 240)
        # Click [Remove]
        tips_area_page.click_TipsArea_btn_Remove()
        time.sleep(DELAY_TIME)
        ...
        # 4.5 Timeline operation > Range selection > Cut
        timeline_operation_page.set_range_markin_markout(240, 330)
        # Click [Cut]
        tips_area_page.click_TipsArea_btn_Cut()
        time.sleep(DELAY_TIME)
        ...
        # [565] 6.1 Timeline operation > Ripple Editing > Trim to Fit (video only)
        with uuid("32b3fc79-6dfb-4ff5-9348-15e4b6d6dce1") as case:
            # Click timeline track 1
            main_page.timeline_select_track(1)
    ...
    # 7 uuid
    # BFT 365 version is test_1_1_34
    # @pytest.mark.skip
    @exception_screenshot
    def test_6_9(self):
        # launch PDR
        ...
        # [L533] 5. Produce > H.265 > Open pack project
        with uuid("8281b84c-4b96-4801-8d13-6160084f73c8") as case:
            # Open project: first_project
            main_page.top_menu_bar_file_open_project(save_changes='no')
            check_open_result = main_page.handle_open_project_dialog(Test_Material_Folder + 'BFT_PDR21_Ess/third_project.pdk')
            main_page.handle_merge_media_to_current_library_dialog(option='no', do_not_show_again='no')
            ...
            if not check_open_result:
                ...
                # Select extract path
                main_page.delete_folder(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_3')
                time.sleep(DELAY_TIME)
                main_page.select_file(Test_Material_Folder + 'BFT_PDR21_Ess/extract_flder_3')
                time.sleep(DELAY_TIME * 5)
                main_page.handle_merge_media_to_current_library_dialog(do_not_show_again='no')
        ...
        # [L498] 4.5 Timeline operation > Range selection > Produce Range
        with uuid("806ada7f-9a80-4ce0-8d42-25117181f691") as case:
            ...
            produce_page.local.set_preview_timecode('00_00_00_00')
            time.sleep(DELAY_TIME)

        # [L534] 5 Produce > H.265 > Select Format > MOV
        ...
        # [L535] 5 Produce > H.265 > Select Format > 1280x720/24p
        ...
        # [L536] 5 Produce > H.265 > Enable HW
        ...
        # [L537] 5 Produce > H.265 > Set [Surround Sound] > AAC 5.1
        ...
        # [L538] 5 Produce > H.265 > [Start] > Produce
        with uuid("4e526fa8-9881-4304-ab8e-d90fd0825309") as case:
            ...
            if check_produce_file:
                ...
                check_preview = main_page.snapshot(locator=L.pip_designer.preview,
                                                   file_name=Auto_Ground_Truth_Folder + 'L401_Essential.png')
                compare_result = main_page.compare(Ground_Truth_Folder + 'L401_Essential.png', check_preview)
