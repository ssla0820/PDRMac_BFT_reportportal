...
class Test_BFT_365_OS14():
    ...
    def test_1_1_1(self):
        ...
        with uuid("600a1107-4281-415c-bda2-f4923e7ebd48") as case:
            if main_page.exist(L.base.seasonal_bb_window.main, timeout=7):
                ...
                verify_result = True
                time.sleep(DELAY_TIME * 2)
            case.result = verify_result

        # [L92] Able to sign in account
        with uuid("89b5f8e9-dc8f-42d7-9fda-2771939dfb81") as case:
            # [L93] Able to sign in account
        ...
        # [L84] Tick/Un-tick "Show Launcher after close program"
        with uuid("ae748270-f3c2-40a4-abfb-29c9cac00762") as case:
            ...
            case.result = check_default and test_default
    ...
    def test_1_1_1_b(self):
        ...
        # [L96] On Boarding flow_1 > Check default "Media Library"
        with uuid("26e3ee5d-f35e-462d-bc4a-806d507ae850") as case:
            verify_step = False
        ...
        with uuid("f5a29d63-68fa-4554-8d72-05f5df80812a") as case:
            ...
            case.result = verify_bubble_1 and verify_bubble_2
        ...
        with uuid("db557877-2404-45b1-a573-bb9931430283") as case:
            ...
            case.result = bubble_1_preview_result and bubble_2_preview_result
        ...
        with uuid("c3af3f4a-a05d-4596-ab93-1f03b76b1f7c") as case:
            ...
            # verify step: blue bubble does Not find
            verify_bubble_1 = False
            verify_bubble_2 = False
            if not main_page.is_exist(L.media_room.string_on_boarding_blue_bubble_media, timeout=5):
                verify_bubble_1 = True
            if not main_page.is_exist(L.media_room.string_on_boarding_blue_bubble_tooltip, timeout=5):
                verify_bubble_2 = True
        ...
        with uuid("129dbc9e-602c-4a86-b469-42bbcddb58e3") as case:
            case.result = main_page.exist(L.media_room.btn_stock_media)
        ...
        with uuid("55f5f7ca-3abc-4533-84ca-58a046a00dc9") as case:
            ...
            case.result = cutout_bubble_preview
        ...
        with uuid("00f15326-015a-4964-b04a-02ab6761d196") as case:
            case.result = main_page.is_exist(L.pip_designer.chromakey.cutout_button)
        ...
        with uuid("69c41107-275a-4644-94f3-fd43bcc33fbf") as case:
            ...
            time.sleep(DELAY_TIME * 3)
            # Select template (search library: Winter 01)
            media_room_page.search_library('Winter 01')
            time.sleep(DELAY_TIME * 4)
            main_page.select_library_icon_view_media('Winter 01')
            ...
            case.result = not main_page.is_exist(L.pip_designer.chromakey.cutout_button)
    ...
    def test_1_1_2(self):
        ...
        with uuid("6e03aff5-5870-41fc-add3-a2358348a59a") as case:
            ...
            # [L310] 3.1 Video Intro Designer > Edit > Trim Video
    ...
    def test_1_1_5(self):
        ...
        with uuid("4ddeabc0-9f40-4621-bd9a-118beeef450e") as case:
            ...
            main_page.enter_room(4)
            time.sleep(DELAY_TIME * 3)
            # Select template (21.6.5219 : search then select Mood 09)
    ...
    def test_1_1_8(self):
        ...
        with uuid("36403805-ed5c-4f70-91e5-1d2fa25e3049") as case:
            ...
            check_ease_out = main_page.compare(no_ease_out_preview, apply_ease_out_preview, similarity=0.99)
            logger(f'{check_ease_out=}')
            # Similarity should less than 0.98, check_ease_out should be False
            check_ease_in = main_page.compare(no_ease_in_preview, apply_ease_in_preview, similarity=0.98)
            logger(f'{check_ease_in=}')
    ...
    def test_3_1_1(self):
        ...
        with uuid("a095de47-8e47-44b3-8030-5f1a08c621ee") as case:
            ...
            verify_result = main_page.select_library_icon_view_media('Love 06')
    ...
    def test_3_1_3(self):
        ...
        with uuid("8b1ebdc6-8076-4b6b-849d-3e1a6f72b20b") as case:
            ...
            # Check insert template title
            elem = main_page.exist(L.title_designer.area.edittext_text_content)
            if elem.AXValue == 'Romance 01':
                check_title = True
            else:
                check_title = False
                logger(f'{elem.AXValue=}')
            logger(check_title)
            ...
            #  80% < similarity < 90%
            preview_is_update = main_page.compare(current_image, after_move_image, similarity=0.80)
            preview_not_the_same = not main_page.compare(current_image, after_move_image, similarity=0.90)
            logger(f'{preview_is_update=}, {preview_not_the_same=}, {check_title=}')
            case.result = preview_is_update and preview_not_the_same and check_title
        ...
        with uuid("847e1d95-b03d-4180-816d-a8e538e0ffa2") as case:
            ...
            compare_result = main_page.compare(Ground_Truth_Folder + 'L351_title.png', current_preview, similarity=0.85)
            case.result = compare_result
    ...
    def test_4_1_16(self):
        ...
        with uuid("8d6fe590-d4af-4ac4-8e7d-e7e4295d4a17") as case:
            ...
            main_page.drag_transition_to_timeline_clip('Binary 1', 'Mood 07')
            ...
            main_page.drag_transition_to_timeline_clip('Blur', 'Mood 07')
            ...
            main_page.drag_transition_to_timeline_clip('Brush Strokes 01', 'Mood 07')
            ...
            main_page.drag_transition_to_timeline_clip('Cross 2', 'Mood 07')
            ...
            main_page.drag_transition_to_timeline_clip('Magnify', 'Mood 07')
            ...
            # Insert (Magnify) to (Wedding 2) and (Dialog_07)
            main_page.drag_transition_to_timeline_clip('Disturbance', 'Mood 07')
    ...
    def test_5_1_3(self):
        ...
        with uuid("2d27aa22-1ce3-48b1-a3b2-934854863832") as case:
            ...
            # [2025/01/20] Change to select "Love" category
        ...
        with uuid("742df028-c7ef-4515-83df-54d53757974f") as case:
            ...
            # [2025/01/20] Change to select "Pointers" category
            # main_page.select_LibraryRoom_category('Japanese Text')
            main_page.select_LibraryRoom_category('Pointers')
            time.sleep(DELAY_TIME * 2)
        ...
        with uuid("b91ad9ce-d6ce-4eec-b215-a5f3e330a3a4") as case:
            ...
            media_room_page.select_specific_category('Pop')
            time.sleep(DELAY_TIME * 4)
    ...
    def test_7_1_2(self):
        ...
        #     verify_step_1 = not main_page.compare(empty_result, name_result, similarity=0.96)
        #     verify_step_2 = not main_page.compare(create_date_result, name_result, similarity=0.96)
        #     logger(f'{verify_step_1=}, {verify_step_2=}')
        #     case.result = verify_step_1 and verify_step_2
    ...
    def test_9_1_6(self):
        ...
        with uuid("3b016c0d-8aab-42de-9a96-d2ab76b8cafb") as case:
            ...
            check_library_update_2 = not main_page.compare(sort_by_name_again_library, sort_by_create_date_library)

            case.result = check_library_update_1 and check_library_update_2
            logger(f'{check_library_update_1=}, {check_library_update_2=}')
        pip_room_page.sort_by_name()
        time.sleep(DELAY_TIME * 2)
